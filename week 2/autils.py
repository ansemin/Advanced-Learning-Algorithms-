...
def load_data():
    X = np.load(r"C:\Users\ansem\Downloads\Files (4)\Files\home\jovyan\work\data\X.npy")
    y = np.load(r"C:\Users\ansem\Downloads\Files (4)\Files\home\jovyan\work\data\y.npy")
    return X, y
